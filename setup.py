...
build_exe_options = {
    ...
    "includes": 'vtkmodules.all',
}

bdist_mac_options = {
    "bundle_name": "Simba",
    "iconfile": '/Users/danieljiang/Documents/UMTRI_3D_Scan_Processing/logo.ico',
}
...
executables = [Executable("main.py", icon="logo.ico",base=base, target_name="Simba")]
